    ...
    return (
        <>
            <IonItem>
                ...
                <IonDatetime color="primary" displayFormat="MMMM DD, YYYY" min="1994-01-01" max="2021-12-31" value={selectedDate} onIonChange={e => setSelectedDate(e.detail.value!)}></IonDatetime>
            </IonItem>
        </>
    );
};
