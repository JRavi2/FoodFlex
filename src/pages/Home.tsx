      ...
      {!props.isVendor ? (
        <IonContent className="content">
          ...
          <IonCard className="main-card ion-text-center">
            ...
            <IonCardContent className="ion-text-center">{recomPrice !== 0 ? recomPrice : ""}</IonCardContent>
          </IonCard>
          <Cards fabButton={pencilOutline} startIcon={cashOutline} CardCon={BudgetContent}>
            Update Budget
          </Cards>
